            ...
            <div class="container form-container">
                <div class="signin-content signup-content">
                    ...
                    <div class="signin-form signup-form">
                        <h2 class="form-title">Agent Log In</h2>
                        <form action="includes/agent-login-auth.php" method="POST" class="register-form" id="login-form">
